...
import { CAMPUS_OPTIONS } from '@/constants/options';
...
describe('CadastroPage', () => {
  ...
  it('should show error message when submission fails with duplicate email', async () => {
    ...
    await waitFor(() => {
      expect(screen.getAllByText(/já está cadastrado/i).length).toBeGreaterThan(0);
    }, { timeout: 3000 });
  });
});
