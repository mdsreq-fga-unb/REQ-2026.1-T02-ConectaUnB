          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-white">
            ...
            <div className="flex-1 w-full space-y-4 max-w-md">
              <input
                ...
                placeholder="Nome"
                disabled
                className="w-full px-5 py-2.5 bg-transparent border border-[#006633] rounded-full text-[#1D1D1D] font-medium focus:outline-none disabled:bg-gray-50"
              />
              <input
                type="text"
            ...
            <div className="flex flex-col gap-4 w-full md:w-auto">
              <button className="px-6 py-2.5 bg-[#006633] text-white font-medium rounded-full hover:bg-[#004d26] transition-colors whitespace-nowrap">
                Editar Perfil
              </button>
