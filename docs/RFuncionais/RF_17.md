...
- [x]**RN4:** O cadastro do perfil de usuário só será considerado concluído quando o usuário preencher corretamente os campos obrigatórios e receber a mensagem de "conta criada com sucesso".
...
PREENCHER (ta passando en todas as regras de negócio mesmo?)