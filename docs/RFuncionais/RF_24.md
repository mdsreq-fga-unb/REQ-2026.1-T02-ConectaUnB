...
## Descrição
O sistema deve permitir a publicação de projetos contendo texto e imagem.
...
## Regras de negócio
- [x] **RN1:** O projeto deve ter foto, banner, nome, descrição, colaboradores.
...
## Tela Final
![Image](../assets/fotos_entregue/rf24.png)
