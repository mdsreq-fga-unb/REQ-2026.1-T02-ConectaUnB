...
| RF-16 | Excluir perfil da usuário | O sistema deve permitir a exclusão dos dados de um perfil de usuário. | CP1 | RF-2-01 | Must Have | A exclusão do perfil de usuário só será considerada concluída quando o usuário confirmar a exclusão da conta, receber a mensagem “Conta excluída com sucesso” na tela e for redirecionado para a página inicial com a navbar no formato deslogado. |
