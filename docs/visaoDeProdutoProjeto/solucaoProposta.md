...
| :---: | :---: | :---: | :--- | :--- | :---: | :--- |
| OE1 | OE5, OE3 | CP1 | Perfil individual para cada entidade e usuário | Cada entidade contará com um perfil o qual trará todos os processos seletivos em aberto, projetos antigos e publicações anteriores. | VN1 | Divulgação padronizada das entidades da instituição. |
...
| OE4 | OE1 | CP3 | Visualização de estatística de pesquisa e busca | Dados sobre inscrições e engajamento com filtros serão coletados segundo as normas da LGPD. | VN3 | Entender melhor as maiores demandas e o engajamento dos projetos da instituição. |
| OE1 | OE3, OE5 | CP4 | Publicações independentes | Cada entidade poderá fazer publicações com texto e fotos conforme sua necessidade, divulgando processos, conquistas e suas ações para toda comunidade. Somente publicadores terão essa possibilidade. | VN4 | Facilitação na disseminação de processos e ações das entidades. |
| OE2 | OE3 | CP5 | Categorização dos perfis por áreas de interesse | Os perfis serão categorizados de acordo com o tipo de sua entidade (Ex: EJ, equipes de competição, etc.), área de atuação, etc. | VN5 | Melhoria do processo interno de descoberta de projetos por parte dos alunos. |
| OE5 | OE3, OE2 | CP6 | Catálogo digital de processos e entidades | Processos e entidades atuais e passadas serão armazenados e ainda poderão ser visualizados | VN6 | Preservação e exposição do histórico do ecossistema da universidade. |
| OE3 | OE2 | CP7 | Navegação na plataforma sem a necessidade de perfil | A solução deverá permitir acesso público a todos os perfis, inicialmente sem a necessidade de login, permitindo visibilidade e democratizando o acesso às informações. Sendo necessário fazer login somente se o usuário quiser interagir ou participar de algum processo. | VN7 | Ampliação da visibilidade institucional para a sociedade, mantendo a democratização do acesso interno. |
